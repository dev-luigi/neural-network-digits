...
from project import AUTHOR, GITHUB_PROFILE, NAME, PROJECT_PAGE, RELEASES_PAGE, VERSION, WEBSITE
...
def changelog_page(parent):
    ...
    try:
        changelog = (updater.APP_DIR / "CHANGELOG.md").read_text(encoding="utf-8")
    except OSError:
        changelog = ""
